...
[中文文档](README_zh.md) | [Paper]() | [Documentation](docs/)
...
```bibtex
@article{yourname2024psychological,
  title={Intelligent Psychological Counseling Dialogue System Based on Dual-Knowledge-Base RAG and Three-Layer Memory},
...
- **Issues**: [GitHub Issues](https://github.com/yourusername/psychological_counseling_system/issues)
...
- [SmileChat Dataset](https://github.com/qiuhuachuan/smile) for professional counseling dialogues
...
This system is designed for research purposes and should **not** be used as a replacement for professional mental health services. If you or someone you know is experiencing a mental health crisis, please contact a licensed mental health professional or emergency services immediately.
